...
class PacienteAdmin(admin.ModelAdmin):
    ...
    search_fields = ("usuario__nome_completo", "responsavel_nome", "responsavel_cpf")
    ...
    fieldsets = (
        ...
        ("Termos e Condições", {"fields": ("aceite_termos", "data_aceite_termos")}),
    )
...
class MotoristaAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Documentação", {"fields": ("cnh_numero", "cnh_validade")}),
        (
            "Status e Aprovação",
            {
                "fields": (
...
class CorridaAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Participantes", {"fields": ("paciente", "motorista")}),
        (
            "Endereços",
            {
                "fields": (
        ...
        ("Metadados", {"fields": ("data_criacao", "data_atualizacao")}),
    )
    ...
    def get_motorista_nome(self, obj):
        if obj.motorista:
            return (
                obj.motorista.usuario.get_full_name() or obj.motorista.usuario.username
            )
        return "-"
