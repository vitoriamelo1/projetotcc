...
class Paciente(models.Model):
    ...
    necessita_cadeira_rodas = models.BooleanField(
        default=False,
        verbose_name='Necessita Cadeira de Rodas'
    )
    imunossuprimido = models.BooleanField(
        default=False,
        verbose_name='Paciente Imunossuprimido'
    )
...
class Motorista(models.Model):
    ...
    online = models.BooleanField(
        default=False,
        verbose_name='Motorista Online'
    )
    aceite_termos_voluntariado = models.BooleanField(
        default=False,
        verbose_name='Aceite dos Termos de Voluntariado'
    )
    data_aceite_termos = models.DateTimeField(
        null=True,
        blank=True,
    ...
    total_corridas = models.IntegerField(
        default=0,
        verbose_name='Total de Corridas Realizadas'
    )
...
class Corrida(models.Model):
    ...
    data_hora_aceite = models.DateTimeField(
        null=True,
        blank=True,
        verbose_name='Data e Hora do Aceite'
    )
    data_hora_inicio = models.DateTimeField(
        null=True,
        blank=True,
        verbose_name='Data e Hora do Início'
    )
    data_hora_chegada = models.DateTimeField(
        null=True,
        blank=True,
        verbose_name='Data e Hora da Chegada'
    )
